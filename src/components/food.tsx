...
query DetailQuery($slug: String, $locale: [Locales]) {
  FoodPage(locale: $locale, where: {
    ContentLink: {
      Url: {
        endsWith: $slug
      }
                ...
                <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                    <div className="flex flex-col-reverse">
                                ...
                                <div className="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring focus:ring-opacity-50 focus:ring-offset-4">
                                    <>
                                        ...
                                        <span className="absolute inset-0 overflow-hidden rounded-md">
                                            <img src={`${process.env.CMS_SAAS}${foodPage.Image}`} alt="" className="h-full w-full object-cover object-center" />
                                        </span>
                                        <span
                        ...
                        <div className="aspect-h-1 aspect-w-1 w-full">
                            <img
                                src={`${process.env.CMS_SAAS}${foodPage.Image}`}
                                alt={foodPage.Name}
